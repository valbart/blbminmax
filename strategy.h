...
public:
    ...
    Strategy (bidiarray<Sint16>& blobs,
            ...
            : _blobs(blobs),_holes(holes), _current_player(current_player), _saveBestMove(saveBestMove), profondeurExplo(4)
            {
    ...
    Strategy (bidiarray<Sint16>& blobs,
                ...
                const Uint16 current_player,
                void (*saveBestMove)(move&),
                const move & move_todo, // le movement correspondant à celui pour lequel on a créeer la strategie
